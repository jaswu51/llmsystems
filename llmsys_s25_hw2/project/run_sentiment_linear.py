...
class Linear(minitorch.Module):
    ...
    def forward(self, x):
        ...
        return x @ weights + self.bias.value.view(1, self.out_size)
...
class Network(minitorch.Module):
    ...
    def forward(self, embeddings):
        ...
        hidden = self.layer1(embeddings)
        hidden = minitorch.dropout(hidden.relu(), self.dropout_prob)
    ...
    def train(
        ...
        for epoch in range(1, max_epochs + 1):
            ...
            for batch_num, example_num in enumerate(
                ...
                # Compute loss
                loss = minitorch.nn.binary_cross_entropy(out, y)
